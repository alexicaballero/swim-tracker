using SwimTracker.Api.ResultPattern.Endpoints;
using SwimTracker.Api.ResultPattern.Endpoints.Clubs;
using SwimTracker.Api.ResultPattern.Endpoints.Swimmers;
using SwimTracker.Api.ResultPattern.Endpoints.Weatherforecast;
